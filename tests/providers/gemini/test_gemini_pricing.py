...
class TestGeminiCostBreakdown:
    ...
    def test_cost_breakdown_detailed(self):
        ...
        assert breakdown.total_cost == breakdown.input_cost + breakdown.output_cost + breakdown.context_cache_cost
...
class TestCostOptimization:
    ...
    def test_optimization_no_savings_available(self):
        ...
        meaningful_savings = [rec for rec in recommendations if rec["savings"] > 0.000001]
...
class TestPricingConstants:
    ...
    def test_pricing_consistency(self):
        ...
        free_models = [info for info in GEMINI_MODELS.values() if info.tier == GeminiTier.FREE]
        ...
        paid_models = [info for info in GEMINI_MODELS.values() if info.tier == GeminiTier.PAID]
    ...
    def test_model_hierarchy_pricing(self):
        ...
        if flash_lite and flash and pro:
            ...
            assert flash_lite.input_price_per_1m_tokens <= flash.input_price_per_1m_tokens
            assert flash_lite.output_price_per_1m_tokens <= flash.output_price_per_1m_tokens
