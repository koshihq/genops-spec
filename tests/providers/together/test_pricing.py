...
class TestTogetherPricingCalculator:
    ...
    def test_estimate_chat_cost_with_input_output_tokens(self):
        ...
        model = "meta-llama/Meta-Llama-3.1-8B-Instruct-Turbo"
        cost = self.calc.estimate_chat_cost(
            model,
            input_tokens=500,
            output_tokens=300
        )
    ...
    def test_get_model_tier_classification(self):
        ...
        # Test lite tier
        tier_8b = self.calc.get_model_tier("meta-llama/Meta-Llama-3.1-8B-Instruct-Turbo")
        assert tier_8b == "lite"

        # Test standard tier
        tier_70b = self.calc.get_model_tier("meta-llama/Meta-Llama-3.1-70B-Instruct-Turbo")
        assert tier_70b == "standard"

        # Test large tier
        tier_405b = self.calc.get_model_tier("meta-llama/Meta-Llama-3.1-405B-Instruct-Turbo")
        assert tier_405b == "large"

    def test_get_model_context_length(self):
        """Test model context length retrieval."""
        # Test known model
        context_8b = self.calc.get_model_context_length("meta-llama/Meta-Llama-3.1-8B-Instruct-Turbo")
