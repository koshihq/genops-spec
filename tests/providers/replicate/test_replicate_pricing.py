...
class TestHybridCostCalculation:
    ...
    def test_hybrid_cost_calculation(self, calculator, hybrid_model_info):
        ...
        input_data = {
            "prompt": "Complex analysis request requiring both tokens and processing time"
        }
        output = (
            "Detailed analysis response with comprehensive information and insights"
        )
        ...
        assert (
            ...
            == breakdown.input_cost + breakdown.output_cost + breakdown.hardware_cost
        )
...
class TestOptimizationRecommendations:
    ...
    def test_high_token_usage_recommendations(self, calculator):
        ...
        assert any(
            "limit response" in rec.lower() or "max_tokens" in rec.lower()
...
class TestModelAlternatives:
    ...
    def test_get_cheaper_alternatives(self, calculator):
        ...
        for _model_name, cost_ratio, reason in alternatives:
    ...
    def test_alternatives_same_category(self, calculator):
        ...
        for model_name, _cost_ratio, _reason in alternatives:
