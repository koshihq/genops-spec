...
class TestGenOpsDustAdapter:
    ...
    def test_make_request_error(self):
        ...
        with patch('requests.Session') as mock_session:
            ...
            mock_session.return_value.request.side_effect = requests.RequestException("API Error")
    ...
    def test_search_datasources_success(self, mock_telemetry):
        ...
        with patch('requests.Session') as mock_session:
            ...
            mock_span.set_attribute.assert_any_call("tokens_estimated_output", pytest.approx(20, rel=0.5))
...
class TestAttributeExtraction:
    ...
    def test_governance_attributes_separation(self):
        ...
        with patch('requests.Session'):
            ...
            expected_governance = {
                "team", "project", "feature", "customer_id", 
