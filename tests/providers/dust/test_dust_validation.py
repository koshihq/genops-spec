...
class TestValidateSetup:
    ...
    def test_validate_setup_success(self):
        ...
        with patch.dict(os.environ, {
            ...
            with patch('genops.providers.dust_validation.check_dust_connectivity') as mock_conn:
                with patch('genops.providers.dust_validation.check_workspace_access') as mock_access:
    ...
    def test_validate_setup_with_explicit_credentials(self):
        ...
        with patch('genops.providers.dust_validation.check_dust_connectivity') as mock_conn:
            with patch('genops.providers.dust_validation.check_workspace_access') as mock_access:
                ...
                mock_conn.assert_called_with("explicit-key", "explicit-workspace", "https://dust.tt")
                mock_access.assert_called_with("explicit-key", "explicit-workspace", "https://dust.tt")
    ...
    def test_validate_setup_custom_base_url(self):
        ...
        with patch('genops.providers.dust_validation.check_dust_connectivity') as mock_conn:
            with patch('genops.providers.dust_validation.check_workspace_access') as mock_access:
                ...
                mock_conn.assert_called_with("test-key", "test-workspace", "https://custom.dust.tt")
                mock_access.assert_called_with("test-key", "test-workspace", "https://custom.dust.tt")
...
class TestPrintValidationResult:
    ...
    def test_print_validation_result_failure(self, mock_print):
        ...
        result = ValidationResult(
            is_valid=False,
            issues=[
                ValidationIssue("error", "environment", "Missing API key", "Set DUST_API_KEY"),
