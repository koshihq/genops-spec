...
class TestDustPricing:
    ...
    def test_dust_pricing_defaults(self):
        ...
        pricing = DustPricing(
            pro_monthly_per_user=29.0, enterprise_monthly_per_user=None
        )
...
class TestDustPricingEngine:
    ...
    def test_calculate_subscription_cost_pro_monthly(self):
        ...
        cost = engine.calculate_subscription_cost(
            user_count=5, plan_type="pro", billing_period="monthly"
        )
    ...
    def test_calculate_subscription_cost_pro_annual(self):
        ...
        cost = engine.calculate_subscription_cost(
            user_count=3, plan_type="pro", billing_period="annual"
        )
    ...
    def test_calculate_subscription_cost_enterprise(self):
        ...
        cost = engine.calculate_subscription_cost(user_count=50, plan_type="enterprise")
    ...
    def test_calculate_subscription_cost_invalid_plan(self):
        ...
        with pytest.raises(ValueError, match="Unknown plan type"):
            engine.calculate_subscription_cost(user_count=5, plan_type="invalid_plan")
    ...
    def test_estimate_monthly_cost_pro_plan(self):
        ...
        usage_forecast = {"conversations": 100, "agent_runs": 200, "searches": 150}

        estimate = engine.estimate_monthly_cost(
            user_count=5, usage_forecast=usage_forecast, plan_type="pro"
        )
    ...
    def test_estimate_monthly_cost_enterprise_plan(self):
        ...
        estimate = engine.estimate_monthly_cost(
            user_count=25, usage_forecast=usage_forecast, plan_type="enterprise"
        )
...
class TestEdgeCases:
    ...
    def test_zero_users(self):
        ...
        cost = engine.calculate_subscription_cost(user_count=0, plan_type="pro")
    ...
    def test_zero_operations(self):
        ...
        breakdown = engine.calculate_operation_cost(
            operation_type="conversation", operation_count=0, user_count=1
        )
    ...
    def test_negative_values_handling(self):
        ...
        cost = engine.calculate_subscription_cost(user_count=-1, plan_type="pro")
    ...
    def test_empty_usage_forecast(self):
        ...
        estimate = engine.estimate_monthly_cost(
            user_count=3, usage_forecast={}, plan_type="pro"
        )
    ...
    def test_case_insensitive_plan_types(self):
        ...
        cost_upper = engine.calculate_subscription_cost(user_count=2, plan_type="PRO")

        cost_mixed = engine.calculate_subscription_cost(user_count=2, plan_type="Pro")

        cost_lower = engine.calculate_subscription_cost(user_count=2, plan_type="pro")
