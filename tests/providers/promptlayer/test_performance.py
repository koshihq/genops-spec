...
@pytest.mark.skipif(
    not PROMPTLAYER_AVAILABLE, reason="PromptLayer provider not available"
)
class TestPerformanceBenchmarks:
    ...
    def test_single_operation_latency(self):
        ...
        for i in range(num_operations):
            ...
            with self.adapter.track_prompt_operation(f"latency_test_{i}") as span:
                self.adapter.run_prompt_with_governance(
                    prompt_name=f"latency_test_{i}", input_variables={"iteration": i}
                )
        ...
        print(
            f"Single operation latency - Avg: {avg_latency:.2f}ms, "
    ...
    def test_span_creation_overhead(self):
        ...
        print(
            f"Span creation overhead - Total: {total_time:.2f}ms, "
    ...
    def test_concurrent_operations_performance(self):
        ...
        print(
            f"Concurrent performance - Throughput: {throughput:.1f} ops/sec, "
    ...
    def test_high_volume_operations_performance(self):
        ...
        print(
            f"High volume performance - {num_operations} ops in {total_time:.1f}ms, "
...
class TestMemoryUsage:
    ...
    def test_memory_usage_single_operations(self):
        ...
        with patch("genops.providers.promptlayer.PromptLayer"):
            adapter = GenOpsPromptLayerAdapter(
                promptlayer_api_key="pl-memory-test", team="memory-team"
            )
            ...
            print(
                f"Memory usage - Total increase: {memory_increase:.2f}MB, "
    ...
    def test_memory_cleanup_after_operations(self):
        ...
        with patch("genops.providers.promptlayer.PromptLayer"):
            adapter = GenOpsPromptLayerAdapter(
                promptlayer_api_key="pl-cleanup-test", team="cleanup-team"
            )
            ...
            print(
                f"Memory cleanup - Retained: {memory_increase:.2f}MB after {num_operations} operations"
            )
    ...
    def test_long_running_memory_stability(self):
        ...
        with patch("genops.providers.promptlayer.PromptLayer"):
            adapter = GenOpsPromptLayerAdapter(
                promptlayer_api_key="pl-stability-test", team="stability-team"
            )
            ...
            print(
                f"Memory stability - Variation: {memory_variation:.2f}MB, "
...
class TestScalabilityPatterns:
    ...
    def test_batch_operation_efficiency(self):
        ...
        with patch("genops.providers.promptlayer.PromptLayer") as mock_pl:
            ...
            adapter = GenOpsPromptLayerAdapter(
                promptlayer_api_key="pl-batch-test", team="batch-team"
            )
            ...
            print(
                f"Batch efficiency - Individual: {individual_time:.1f}ms, "
    ...
    def test_connection_pooling_simulation(self):
        ...
        with patch("genops.providers.promptlayer.PromptLayer") as mock_pl:
            ...
            for i in range(10):
                adapter = GenOpsPromptLayerAdapter(
                    promptlayer_api_key="pl-no-pooling", team="no-pooling-team"
                )
            ...
            shared_adapter = GenOpsPromptLayerAdapter(
                promptlayer_api_key="pl-pooling", team="pooling-team"
            )
            for i in range(10):
            ...
            print(
                f"Connection pooling - No pooling: {no_pooling_time:.1f}ms, "
    ...
    def test_auto_instrumentation_overhead(self):
        ...
        with patch("genops.providers.promptlayer.PromptLayer") as mock_pl:
            ...
            manual_adapter = GenOpsPromptLayerAdapter(
                promptlayer_api_key="pl-manual", team="manual-team"
            )
            ...
            with patch(
                "genops.providers.promptlayer.GenOpsPromptLayerAdapter"
                ...
                for i in range(100):
                    ...
                    mock_adapter.track_prompt_operation(f"auto_{i}").__exit__(
                        None, None, None
                    )
                ...
                print(
                    f"Auto-instrumentation overhead - Manual: {manual_time:.1f}ms, "
...
class TestCacheOptimization:
    ...
    def test_span_metadata_caching(self):
        ...
        with patch("genops.providers.promptlayer.PromptLayer"):
            adapter = GenOpsPromptLayerAdapter(
                promptlayer_api_key="pl-cache-test", team="cache-team"
            )
            ...
            print(
                f"Metadata caching - {cache_time:.1f}ms total, "
    ...
    def test_cost_calculation_optimization(self):
        ...
        for i in range(num_calculations):
            span = EnhancedPromptLayerSpan(
                operation_type="cost_calc_test", operation_name=f"calc_{i}"
            )
        ...
        print(
            f"Cost calculation performance - {calc_time:.1f}ms total, "
...
class TestResourceUsageOptimization:
    ...
    def test_thread_safety_performance(self):
        ...
        with patch("genops.providers.promptlayer.PromptLayer"):
            adapter = GenOpsPromptLayerAdapter(
                promptlayer_api_key="pl-thread-safety", team="thread-team"
            )
            ...
            for worker_id in range(num_workers):
                thread = threading.Thread(
                    target=worker_function, args=(worker_id, ops_per_worker)
                )
            ...
            print(
                f"Thread safety performance - {throughput:.1f} ops/sec, "
    ...
    def test_garbage_collection_impact(self):
        ...
        with patch("genops.providers.promptlayer.PromptLayer"):
            adapter = GenOpsPromptLayerAdapter(
                promptlayer_api_key="pl-gc-test", team="gc-team"
            )
            ...
            print(
                f"GC impact - No GC: {no_gc_time:.1f}ms, "
    ...
    def test_operation_cleanup_efficiency(self):
        ...
        with patch("genops.providers.promptlayer.PromptLayer"):
            adapter = GenOpsPromptLayerAdapter(
                promptlayer_api_key="pl-cleanup-efficiency", team="cleanup-team"
            )
            ...
            print(
                f"Cleanup efficiency - Avg: {avg_cleanup_time:.1f}ms, "
