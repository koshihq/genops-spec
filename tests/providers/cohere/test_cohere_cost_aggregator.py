...
class TestCohereCostAggregator:
    ...
    def test_record_operation_with_governance_attributes(self, aggregator, sample_cost_breakdown):
    ...
    def test_get_cost_summary_by_model(self, aggregator):
        ...
        for model_data in models_data:
            for _ in range(model_data["count"]):
                operation_type = CohereOperation.EMBED if "embed" in model_data["model"] else CohereOperation.CHAT
    ...
    def test_cost_optimization_insights(self, aggregator):
        ...
        expensive_operations = [
            ("command-r-plus-08-2024", CohereOperation.CHAT, 0.010, 10),  # High-cost model
    ...
    def test_budget_alert_functionality(self, aggregator):
        ...
        budget_alert = next((alert for alert in alerts if alert.type == "budget_threshold"), None)
...
class TestCostSummary:
    ...
    def test_cost_summary_creation(self):
        ...
        from genops.providers.cohere_cost_aggregator import OverviewSummary, TeamSummary, ModelSummary
...
class TestOptimizationInsights:
    ...
    def test_optimization_insight_ranking(self):
        ...
        sorted_insights = sorted(insights, key=lambda x: x.potential_savings, reverse=True)
