...
class TestCohereValidator:
    ...
    def test_validate_connectivity_network_error(self, validator):
        ...
        with patch("genops.providers.cohere_validation.ClientV2") as mock_client_class:
            ...
            assert (
                "connectivity" in critical_issue.title.lower()
                or "connection" in critical_issue.title.lower()
            )
    ...
    def test_validate_performance_tests(self):
        ...
        validator = CohereValidator(api_key="test-key", include_performance_tests=True)
    ...
    def test_validate_pricing_calculator(self, validator):
        ...
        with patch(
            "genops.providers.cohere_validation.CohereCalculator"
        ) as mock_calc_class:
            mock_calc = Mock()
...
class TestValidationStructures:
    ...
    def test_validation_result_success(self):
        ...
        result = ValidationResult(
            success=True, issues=[], performance_metrics={"test": 100.0}
        )
    ...
    def test_validation_result_with_critical_issues(self):
        ...
        result = ValidationResult(success=False, issues=[critical_issue])
    ...
    def test_validation_result_with_warnings_only(self):
        ...
        result = ValidationResult(success=True, issues=[warning_issue])
...
class TestValidationFunctions:
    ...
    def test_validate_setup_success(self):
        ...
        with patch(
            "genops.providers.cohere_validation.CohereValidator"
            ...
            mock_validator_class.assert_called_once_with(
                api_key="test-key", include_performance_tests=False
            )
    ...
    def test_validate_setup_with_performance(self):
        ...
        with patch(
            ...
            validate_setup(api_key="test-key", include_performance_tests=True)

            mock_validator_class.assert_called_once_with(
                api_key="test-key", include_performance_tests=True
            )

    def test_quick_validate_success(self):
        """Test quick_validate function with successful validation."""
        with patch(
            "genops.providers.cohere_validation.validate_setup"
        ) as mock_validate:
...
class TestValidationIntegration:
    ...
    def test_full_validation_workflow(self):
        ...
        with patch("genops.providers.cohere_validation.HAS_COHERE", True):
            with patch(
                "genops.providers.cohere_validation.ClientV2"
