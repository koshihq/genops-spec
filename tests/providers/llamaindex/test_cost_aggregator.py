...
class TestProviderPricing:
    ...
    def test_calculate_openai_embedding_cost(self, aggregator):
        ...
        cost = aggregator.calculate_embedding_cost("openai", "text-embedding-ada-002", 1000)
    ...
    def test_calculate_cost_unknown_provider(self, aggregator):
        ...
        cost = aggregator.calculate_embedding_cost("unknown_provider", "unknown_model", 1000)
...
class TestOptimizationSuggestions:
    ...
    def test_suggestions_for_high_retrieval_cost(self):
        ...
        retrieval_suggestions = [s for s in suggestions if "retrieval" in s.lower() or "cache" in s.lower()]
...
class TestContextManager:
    ...
    def test_context_manager_with_budget_limit(self):
        ...
        with create_llamaindex_cost_context("test_context", budget_limit=1.0) as aggregator:
