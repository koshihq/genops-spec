...
def mock_validation_result():
    ...
    return {
        ...
        "checks": {
            "databricks_connectivity": {"status": "PASSED", "message": "Connected successfully"},
            "unity_catalog_access": {"status": "PASSED", "message": "Unity Catalog accessible"},
            "environment_variables": {"status": "PASSED", "message": "All required variables set"},
            "governance_config": {"status": "PASSED", "message": "Governance attributes valid"}
        },
        "warnings": [],
        "errors": [],
...
def sample_catalog_operations():
    ...
    return [
        {"operation": "list", "catalog_name": "production", "expected_result": "success"},
        {"operation": "create", "catalog_name": "new_catalog", "expected_result": "success"},
        {"operation": "delete", "catalog_name": "temp_catalog", "expected_result": "success"},
        {"operation": "read", "catalog_name": "analytics", "expected_result": "success"}
    ]
...
def mock_adapter_with_dependencies():
    ...
    with patch('databricks.sdk.WorkspaceClient') as mock_client_class:
        with patch('genops.providers.databricks_unity_catalog.adapter.GenOpsDatabricksUnityCatalogAdapter') as mock_adapter_class:
