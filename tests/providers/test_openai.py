...
class TestGenOpsOpenAIAdapter:
    ...
    def test_governance_attributes_inheritance(self, mock_openai_import, mock_span_recorder):
    ...
    def test_token_estimation_accuracy(self, mock_openai_import):
        ...
        test_cases = [
            ...
            {
                "messages": [
                    {"role": "user", "content": "This is a longer message with more words"},
    ...
    def test_unknown_model_fallback_pricing(self, mock_openai_import, mock_span_recorder):
