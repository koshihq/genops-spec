...
try:
    from genops.providers.bedrock import GenOpsBedrockAdapter, instrument_bedrock, auto_instrument_bedrock
    from genops.providers.bedrock_pricing import calculate_bedrock_cost, compare_bedrock_models
    from genops.providers.bedrock_validation import validate_bedrock_setup, print_validation_result
...
class TestEndToEndWorkflows:
    ...
    def _setup_bedrock_mocks(self, mock_boto_client):
        ...
        def create_mock_response(content, input_tokens=100, output_tokens=50):
            ...
            mock_body = Mock()
            mock_body.read.return_value = f'{{"completion": "{content}", "usage": {{"input_tokens": {input_tokens}, "output_tokens": {output_tokens}}}}}'.encode('utf-8')
...
class TestValidationAndSetupIntegration:
    ...
    def test_validation_result_printing_integration(self, capsys):
        ...
        from genops.providers.bedrock_validation import ValidationResult, ValidationCheck
