...
class KubernetesTestRunner:
    ...
    def run_tests(
        ...
        if output_format == "junit":
            ...
            cmd.extend(["--json-report", "--json-report-file", f"{self.project_root}/test-results.json"])
    ...
    def check_dependencies(self) -> bool:
        ...
        try:
            ...
            if result.returncode == 0:
                ...
                print("⚠️ Kubernetes cluster: not available (some tests will be skipped)")
        except Exception:
