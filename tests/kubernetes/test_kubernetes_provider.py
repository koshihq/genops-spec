...
def mock_kubernetes_environment():
    ...
    with patch.dict(os.environ, env_vars), \
        ...
        def read_text_side_effect():
            ...
            path_str = str(mock_read_text.__self__)  # This is a hack, but works for testing
    ...
    def test_cluster_name_detection(self, mock_kubernetes_environment):
        ...
        try:
            ...
            with patch("pathlib.Path.exists", return_value=True), \
                 patch("builtins.open", mock_open(read_data="current-context: test-cluster-context")):
                detector = KubernetesDetector()
...
class TestKubernetesResourceMonitor:
    ...
    def test_resource_monitor_initialization(self):
        ...
        try:
            from genops.providers.kubernetes.resource_monitor import KubernetesResourceMonitor
    ...
    def test_current_usage_collection(self):
        ...
        try:
            from genops.providers.kubernetes.resource_monitor import KubernetesResourceMonitor, ResourceUsage
...
class TestKubernetesValidation:
    ...
    def test_validation_result_dataclass(self):
        ...
        try:
            from genops.providers.kubernetes.validation import KubernetesValidationResult, ValidationIssue
    ...
    def test_validation_with_options(self, mock_kubernetes_environment):
        ...
        try:
            ...
            cluster_warnings = [issue for issue in result.issues if issue.component == "cluster"]
    ...
    def test_print_validation_result(self, mock_kubernetes_environment):
        ...
        try:
            from genops.providers.kubernetes.validation import validate_kubernetes_setup, print_kubernetes_validation_result
...
class TestErrorHandling:
    ...
    def test_validation_error_handling(self):
        ...
        try:
            ...
            with patch("genops.providers.kubernetes.detector.KubernetesDetector") as mock_detector_class:
                mock_detector = Mock()
