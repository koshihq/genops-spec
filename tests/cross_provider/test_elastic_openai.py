...
class TestElasticOpenAIIntegration:
    ...
    def test_track_openai_completion(
        ...
        with patch(
            ...
            with adapter.track_ai_operation(
                "openai-completion", operation_type="llm.completion", provider="openai"
            ) as span:
                # Record OpenAI cost
                adapter.record_cost(
                    span=span,
    ...
    def test_track_openai_embedding(
        self, sample_elastic_config, mock_elasticsearch_client
    ):
        ...
        with patch(
            ...
            with adapter.track_ai_operation(
                "openai-embedding", operation_type="llm.embedding"
            ) as span:
                adapter.record_cost(
                    span=span,
                    cost=0.0001,
    ...
    def test_track_multiple_openai_models(
        self, sample_elastic_config, mock_elasticsearch_client
    ):
    ...
    def test_openai_streaming_tracking(
        self, sample_elastic_config, mock_elasticsearch_client
    ):
        ...
        with patch(
            ...
            with adapter.track_ai_operation(
                "openai-streaming", operation_type="llm.completion", streaming=True
            ) as span:
    ...
    def test_openai_error_tracking(
        self, sample_elastic_config, mock_elasticsearch_client
    ):
    ...
    def test_openai_cost_by_customer(
        self, sample_elastic_config, mock_elasticsearch_client
    ):
        ...
        with patch(
            ...
            for customer in customers:
                with adapter.track_ai_operation(
                    f"openai-{customer}", customer_id=customer
                ) as span:
                    adapter.record_cost(
    ...
    def test_openai_batch_operations(
        self, sample_elastic_config, mock_elasticsearch_client
    ):
    ...
    def test_openai_function_calling_tracking(
        self, sample_elastic_config, mock_elasticsearch_client
    ):
        ...
        with patch(
            ...
            with adapter.track_ai_operation(
                "openai-function-call", operation_type="llm.function_call"
            ) as span:
                adapter.record_cost(
                    span=span,
                    cost=0.03,
