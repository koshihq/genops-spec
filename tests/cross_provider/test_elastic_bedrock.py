...
class TestElasticBedrockIntegration:
    ...
    def test_track_bedrock_claude(self, sample_elastic_config, mock_elasticsearch_client):
    ...
    def test_track_bedrock_titan(self, sample_elastic_config, mock_elasticsearch_client):
    ...
    def test_track_bedrock_llama(self, sample_elastic_config, mock_elasticsearch_client):
    ...
    def test_track_bedrock_multiple_models(self, sample_elastic_config, mock_elasticsearch_client):
    ...
    def test_track_bedrock_cross_region(self, sample_elastic_config, mock_elasticsearch_client):
    ...
    def test_track_bedrock_embeddings(self, sample_elastic_config, mock_elasticsearch_client):
    ...
    def test_track_bedrock_with_aws_account(self, sample_elastic_config, mock_elasticsearch_client):
        """Test tracking Bedrock with AWS account attribution."""
        with patch('genops.providers.elastic.client.Elasticsearch', return_value=mock_elasticsearch_client):
            adapter = instrument_elastic(**sample_elastic_config, auto_validate=False)

            with adapter.track_ai_operation(
                "bedrock-multi-account",
    ...
    def test_track_bedrock_error_handling(self, sample_elastic_config, mock_elasticsearch_client):
