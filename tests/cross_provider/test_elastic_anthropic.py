...
class TestElasticAnthropicIntegration:
    ...
    def test_track_claude_completion(
        ...
        with patch(
            ...
            assert (
                span.attributes.get("genops.cost.model") == "claude-3-sonnet-20240229"
            )

    def test_track_claude_3_opus(
        self, sample_elastic_config, mock_elasticsearch_client
    ):
    ...
    def test_track_multiple_claude_models(
        self, sample_elastic_config, mock_elasticsearch_client
    ):
    ...
    def test_claude_streaming_tracking(
        self, sample_elastic_config, mock_elasticsearch_client
    ):
        ...
        with patch(
            ...
            with adapter.track_ai_operation(
                "claude-streaming", operation_type="llm.completion", streaming=True
            ) as span:
                # Simulate streaming
                total_tokens_out = 0
                for _i in range(10):
    ...
    def test_claude_long_context_tracking(
        self, sample_elastic_config, mock_elasticsearch_client
    ):
        ...
        with patch(
            ...
            with adapter.track_ai_operation(
                "claude-long-context", context_length=200000
            ) as span:
                adapter.record_cost(
                    span=span,
    ...
    def test_claude_error_tracking(
        self, sample_elastic_config, mock_elasticsearch_client
    ):
    ...
    def test_claude_cost_split_calculation(
        self, sample_elastic_config, mock_elasticsearch_client
    ):
