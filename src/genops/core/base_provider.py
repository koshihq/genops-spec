...
class BaseProvider(ABC):
    ...
    def _create_operation_context(
        self, operation_type: str, **governance_attributes: str
    ):
        ...
        context = OperationContext(
            ...
            governance_attributes=self.get_effective_attributes(
...
class ProviderRegistry:
    ...
    def register(self, name: str, provider_class: type) -> None:
        ...
        if not issubclass(provider_class, BaseProvider):
            raise ValueError(
                f"Provider {provider_class} must inherit from BaseProvider"
            )
...
# Alias for test imports that reference this name from this module
BaseFrameworkProvider = BaseProvider
