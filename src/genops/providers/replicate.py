...
class GenOpsReplicateAdapter:
    ...
    def __init__(
        ...
        if not self.api_token:
            logger.warning(
                "REPLICATE_API_TOKEN not found. Set environment variable for authentication."
            )
        ...
        try:
            ...
            self._pricing = None  # type: ignore[assignment]
        ...
        **kwargs,
        ...
        with tracer.start_as_current_span(
            ...
            try:
                ...
                span.set_attribute(
                    "genops.model_category", model_info.category or "unknown"
                )
                span.set_attribute("genops.pricing_type", model_info.pricing_type)

                if stream:
                    return self._run_streaming(
                        model, input, model_info, governance_attrs, span, **kwargs
                    )
                else:
    ...
    def _run_sync(
        ...
        **kwargs,
        ...
        response = ReplicateResponse(
            ...
            metadata={"governance": governance_attrs, "model_info": asdict(model_info)},
        )
        ...
        if self.debug:
            logger.info(
                f"Replicate operation completed: {model} - ${cost_usd:.6f} ({latency_ms:.0f}ms)"
            )
        ...
        **kwargs,
        ...
        try:
            ...
            if model_info.pricing_type != "token":
                accumulated_cost = self._calculate_cost(
                    model_info, input, None, latency_ms
                )
            ...
            if self.debug:
                logger.info(
                    f"Replicate streaming completed: {model} - ${accumulated_cost:.6f} ({latency_ms:.0f}ms, {token_count} tokens)"
                )
    ...
    def text_generation(
        ...
        **governance_attrs,
        ...
        if max_tokens is not None:
            input_params["max_length"] = max_tokens  # type: ignore[assignment]
        if temperature is not None:
            input_params["temperature"] = temperature  # type: ignore[assignment]
    ...
    def image_generation(
        ...
        **governance_attrs,
        ...
        if width is not None:
            input_params["width"] = width  # type: ignore[assignment]
        if height is not None:
            input_params["height"] = height  # type: ignore[assignment]
        if num_images > 1:
            input_params["num_outputs"] = num_images  # type: ignore[assignment]

        return self.run_model(model, input_params, **governance_attrs)  # type: ignore
    ...
    def video_generation(
        ...
        **governance_attrs,
        ...
        if duration is not None:
            input_params["duration"] = duration  # type: ignore[assignment]
        if fps is not None:
            input_params["fps"] = fps  # type: ignore[assignment]
...
def instrument_replicate(
    api_token: Optional[str] = None, **kwargs
