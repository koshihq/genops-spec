...
def auto_register() -> bool:
    ...
    try:
        ...
        logger.info(
            "Successfully registered Ollama provider with GenOps instrumentation"
        )
        return True
...
def auto_instrument(
    ...
    **governance_defaults,
    ...
    if _adapter_instance is None:
        ...
        _adapter_instance = GenOpsOllamaAdapter(
            ollama_base_url=ollama_base_url, **governance_defaults
        )
    else:
    ...
    try:
        ...
        if "generate" not in _original_methods:
            _original_methods["generate"] = getattr(ollama, "generate", None)  # type: ignore
            _original_methods["chat"] = getattr(ollama, "chat", None)  # type: ignore
            _original_methods["Client.generate"] = getattr(  # type: ignore
                ollama.Client, "generate", None
            )
            _original_methods["Client.chat"] = getattr(ollama.Client, "chat", None)  # type: ignore
        ...
        def instrumented_client_generate(self, model, prompt, **kwargs):
            ...
            try:
                ...
                temp_adapter = GenOpsOllamaAdapter(
                    ollama_base_url=self.host, **_adapter_instance.governance_defaults
                )
                ...
                if _original_methods["Client.generate"]:
                    return _original_methods["Client.generate"](
        ...
        def instrumented_client_chat(self, model, messages, **kwargs):
            ...
            try:
                ...
                if _original_methods["Client.chat"]:
                    return _original_methods["Client.chat"](
...
def disable_auto_instrument() -> bool:
    ...
    try:
        ...
        if (
            "Client.generate" in _original_methods
            and _original_methods["Client.generate"]
        ):
...
def get_instrumentation_status() -> dict[str, Any]:
    ...
    if _adapter_instance:
        ...
        status["telemetry_enabled"] = getattr(
            _adapter_instance, "telemetry_enabled", None
        )
        status["cost_tracking_enabled"] = getattr(
            _adapter_instance, "cost_tracking_enabled", None
        )
...
def reset_instrumentation() -> None:
    ...
    try:
        ...
        set_resource_monitor(None)  # type: ignore[arg-type]
    except Exception:
        pass
