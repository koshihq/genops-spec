...
class GenOpsAnthropicAdapter:
    ...
    def __init__(self, client: Optional[Anthropic] = None, **client_kwargs):
    ...
    def messages_create(self, **kwargs) -> Any:
        ...
        operation_name = f"anthropic.messages.create"
    ...
    def completions_create(self, **kwargs) -> Any:
        ...
        operation_name = f"anthropic.completions.create"
...
def instrument_anthropic(client: Optional[Anthropic] = None, **client_kwargs) -> GenOpsAnthropicAdapter:
    """
...
def unpatch_anthropic():
    ...
    if _original_messages_create is not None:
        ...
        if _original_completions_create is not None and hasattr(anthropic.Anthropic, 'completions'):
