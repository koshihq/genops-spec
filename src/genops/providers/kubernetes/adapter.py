...
from .detector import KubernetesDetector, KubernetesContext
...
class KubernetesGovernanceContext:
    ...
    def to_telemetry_attributes(self) -> Dict[str, Any]:
        ...
        if self.namespace:
            ...
            attributes["genops.tenant"] = self.namespace  # Use namespace as default tenant
        if self.pod_name:
...
class KubernetesAdapter(BaseFrameworkProvider):
    ...
    def __init__(
        ...
        **kwargs
        ...
        logger.info(f"🚢 Kubernetes adapter initialized (K8s detected: {self.detector.is_kubernetes()})")
    ...
    def instrument_operation(
        ...
        **governance_attrs
        ...
        try:
            ...
            logger.info(f"✅ K8s operation completed: {operation_name} ({duration*1000:.2f}ms)")
