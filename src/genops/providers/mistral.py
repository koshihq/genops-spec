...
class GenOpsMistralAdapter:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        try:
            ...
            raise ValueError(f"Failed to initialize Mistral client: {e}") from e
        ...
        logger.info(
            f"GenOps Mistral adapter initialized with session: {self._session_id}"
        )
    ...
    def _update_session_stats(self, usage: MistralUsage):
        ...
        if (
            self.budget_limit
            and self._total_cost >= self.budget_limit * self.cost_alert_threshold
        ):
            logger.warning(
    ...
    def embed(
        self, texts: Union[str, list[str]], model: str = "mistral-embed", **kwargs
    ) -> MistralResponse:
        """
    ...
    def generate(
        self, prompt: str, model: str = "mistral-small-latest", **kwargs
    ) -> MistralResponse:
        """
...
def chat(
    message: str, model: str = "mistral-small-latest", **kwargs
) -> MistralResponse:
...
def embed(
    texts: Union[str, list[str]], model: str = "mistral-embed", **kwargs
) -> MistralResponse:
