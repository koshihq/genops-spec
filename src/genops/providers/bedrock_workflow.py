...
class BedrockProductionWorkflow:
    ...
    def __exit__(self, exc_type, exc_val, exc_tb):
        ...
        if hasattr(self, 'span') and self.span:
            ...
            self.span.set_attribute("bedrock.workflow.total_cost", final_cost_summary.total_cost)
    ...
    def record_step(
        ...
        if self.current_step and self.current_step.status == WorkflowStatus.RUNNING:
            ...
            if self.cost_context:
                ...
                recent_ops = self.cost_context.get_operations_by_timespan(start_time=step_start_time)
