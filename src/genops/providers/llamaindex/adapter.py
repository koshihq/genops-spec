...
class GenOpsLlamaIndexCallback(BaseCallbackHandler):
    ...
    def on_llm_start(self, serialized: Dict[str, Any], prompts: List[str], **kwargs) -> None:
        ...
        event_id = self.on_event_start("llm_call", {
            "prompts": prompts,
    ...
    def on_retrieve_start(self, query: QueryBundle, **kwargs) -> str:
        ...
        return self.on_event_start("retrieve", {
    ...
    def _extract_cost_info(self, operation: LlamaIndexOperation, payload: Dict[str, Any]) -> None:
    ...
    def _extract_provider_info(self, operation: LlamaIndexOperation, model_info: Dict[str, Any]) -> None:
