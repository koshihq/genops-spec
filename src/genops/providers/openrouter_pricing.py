...
class OpenRouterPricingEngine:
    ...
    def _initialize_pricing_database(self) -> dict[str, OpenRouterPricing]:
        ...
        openai_models = {
            "openai/gpt-4o": OpenRouterPricing(
                0.005 / 1000, 0.015 / 1000, provider="openai", model_family="gpt-4o"
            ),
            "openai/gpt-4o-mini": OpenRouterPricing(
                0.00015 / 1000, 0.0006 / 1000, provider="openai", model_family="gpt-4o"
            ),
            "openai/gpt-4-turbo": OpenRouterPricing(
                0.01 / 1000, 0.03 / 1000, provider="openai", model_family="gpt-4"
            ),
            "openai/gpt-4": OpenRouterPricing(
                0.03 / 1000, 0.06 / 1000, provider="openai", model_family="gpt-4"
            ),
            "openai/gpt-3.5-turbo": OpenRouterPricing(
                0.0015 / 1000, 0.002 / 1000, provider="openai", model_family="gpt-3.5"
            ),
            "openai/gpt-3.5-turbo-instruct": OpenRouterPricing(
                0.0015 / 1000, 0.002 / 1000, provider="openai", model_family="gpt-3.5"
            ),
        }
        ...
        anthropic_models = {
            "anthropic/claude-3-5-sonnet": OpenRouterPricing(
                3.00 / 1000000,
                15.00 / 1000000,
                provider="anthropic",
                model_family="claude-3.5",
            ),
            "anthropic/claude-3-5-sonnet:beta": OpenRouterPricing(
                3.00 / 1000000,
                15.00 / 1000000,
                provider="anthropic",
                model_family="claude-3.5",
            ),
            "anthropic/claude-3-5-haiku": OpenRouterPricing(
                1.00 / 1000000,
                5.00 / 1000000,
                provider="anthropic",
                model_family="claude-3.5",
            ),
            "anthropic/claude-3-opus": OpenRouterPricing(
                15.00 / 1000000,
                75.00 / 1000000,
                provider="anthropic",
                model_family="claude-3",
            ),
            "anthropic/claude-3-sonnet": OpenRouterPricing(
                3.00 / 1000000,
                15.00 / 1000000,
                provider="anthropic",
                model_family="claude-3",
            ),
            "anthropic/claude-3-haiku": OpenRouterPricing(
                0.25 / 1000000,
                1.25 / 1000000,
                provider="anthropic",
                model_family="claude-3",
        ...
        google_models = {
            "google/gemini-2.0-flash-exp": OpenRouterPricing(
                0.075 / 1000000,
                0.30 / 1000000,
                provider="google",
                model_family="gemini-2.0",
            ),
            "google/gemini-1.5-pro": OpenRouterPricing(
                1.25 / 1000000,
                5.00 / 1000000,
                provider="google",
                model_family="gemini-1.5",
            ),
            "google/gemini-1.5-flash": OpenRouterPricing(
                0.075 / 1000000,
                0.30 / 1000000,
                provider="google",
                model_family="gemini-1.5",
            ),
            "google/gemini-pro": OpenRouterPricing(
                0.5 / 1000000,
                1.5 / 1000000,
                provider="google",
                model_family="gemini-1.0",
            ),
            "google/gemma-2-9b-it": OpenRouterPricing(
                0.2 / 1000000, 0.2 / 1000000, provider="google", model_family="gemma-2"
            ),
        }

        # Meta Models (via OpenRouter)
        meta_models = {
            "meta-llama/llama-3.2-90b-vision-instruct": OpenRouterPricing(
                0.9 / 1000000, 0.9 / 1000000, provider="meta", model_family="llama-3.2"
            ),
            "meta-llama/llama-3.2-11b-vision-instruct": OpenRouterPricing(
                0.55 / 1000000,
                0.55 / 1000000,
                provider="meta",
                model_family="llama-3.2",
            ),
            "meta-llama/llama-3.2-3b-instruct": OpenRouterPricing(
                0.06 / 1000000,
                0.06 / 1000000,
                provider="meta",
                model_family="llama-3.2",
            ),
            "meta-llama/llama-3.2-1b-instruct": OpenRouterPricing(
                0.04 / 1000000,
                0.04 / 1000000,
                provider="meta",
                model_family="llama-3.2",
            ),
            "meta-llama/llama-3.1-405b-instruct": OpenRouterPricing(
                5.0 / 1000000, 15.0 / 1000000, provider="meta", model_family="llama-3.1"
            ),
            "meta-llama/llama-3.1-70b-instruct": OpenRouterPricing(
                0.9 / 1000000, 0.9 / 1000000, provider="meta", model_family="llama-3.1"
            ),
            "meta-llama/llama-3.1-8b-instruct": OpenRouterPricing(
                0.2 / 1000000, 0.2 / 1000000, provider="meta", model_family="llama-3.1"
            ),
        }

        # Mistral Models (via OpenRouter)
        mistral_models = {
            "mistralai/mistral-large": OpenRouterPricing(
                4.0 / 1000000,
                12.0 / 1000000,
                provider="mistral",
                model_family="mistral-large",
            ),
            "mistralai/mistral-medium": OpenRouterPricing(
                2.7 / 1000000,
                8.1 / 1000000,
                provider="mistral",
                model_family="mistral-medium",
            ),
            "mistralai/mistral-small": OpenRouterPricing(
                1.0 / 1000000,
                3.0 / 1000000,
                provider="mistral",
                model_family="mistral-small",
            ),
            "mistralai/mistral-tiny": OpenRouterPricing(
                0.25 / 1000000,
                0.25 / 1000000,
                provider="mistral",
                model_family="mistral-tiny",
            ),
            "mistralai/mixtral-8x7b-instruct": OpenRouterPricing(
                0.5 / 1000000, 0.5 / 1000000, provider="mistral", model_family="mixtral"
            ),
            "mistralai/mixtral-8x22b-instruct": OpenRouterPricing(
                1.2 / 1000000, 1.2 / 1000000, provider="mistral", model_family="mixtral"
            ),
        }

        # Cohere Models (via OpenRouter)
        cohere_models = {
            "cohere/command-r": OpenRouterPricing(
                0.5 / 1000000,
                1.5 / 1000000,
                provider="cohere",
                model_family="command-r",
            ),
            "cohere/command-r-plus": OpenRouterPricing(
                3.0 / 1000000,
                15.0 / 1000000,
                provider="cohere",
                model_family="command-r",
            ),
            "cohere/command": OpenRouterPricing(
                1.0 / 1000000, 2.0 / 1000000, provider="cohere", model_family="command"
            ),
        }
        ...
        other_models = {
            # Perplexity
            "perplexity/llama-3.1-sonar-small-128k-online": OpenRouterPricing(
                0.2 / 1000000,
                0.2 / 1000000,
                provider="perplexity",
                model_family="sonar",
            ),
            "perplexity/llama-3.1-sonar-large-128k-online": OpenRouterPricing(
                1.0 / 1000000,
                1.0 / 1000000,
                provider="perplexity",
                model_family="sonar",
            ...
            # Databricks
            "databricks/dbrx-instruct": OpenRouterPricing(
                0.75 / 1000000,
                2.25 / 1000000,
                provider="databricks",
                model_family="dbrx",
            ...
            # Together AI
            "togethercomputer/llama-2-7b-chat": OpenRouterPricing(
                0.2 / 1000000,
                0.2 / 1000000,
                provider="together",
            ...
            # Nous Research
            "nousresearch/nous-hermes-2-mixtral-8x7b-dpo": OpenRouterPricing(
                0.5 / 1000000, 0.5 / 1000000, provider="nous", model_family="hermes-2"
            ),
        }
    ...
    def get_model_pricing(self, model_name: str) -> OpenRouterPricing | None:
    ...
    def _get_fallback_pricing(
        self, model_name: str, actual_provider: str | None = None
    ) -> OpenRouterPricing:
        ...
        if actual_provider:
            provider_defaults = {
                "openai": OpenRouterPricing(
                    0.01 / 1000, 0.02 / 1000, provider="openai", model_family="unknown"
                ),
                "anthropic": OpenRouterPricing(
                    3.00 / 1000000,
                    15.00 / 1000000,
                    provider="anthropic",
                    model_family="unknown",
                ),
                "google": OpenRouterPricing(
                    0.5 / 1000000,
                    1.5 / 1000000,
                    provider="google",
                    model_family="unknown",
                ),
                "meta": OpenRouterPricing(
                    0.2 / 1000000,
                    0.2 / 1000000,
                    provider="meta",
                    model_family="unknown",
                ),
                "mistral": OpenRouterPricing(
                    1.0 / 1000000,
                    3.0 / 1000000,
                    provider="mistral",
                    model_family="unknown",
                ),
                "cohere": OpenRouterPricing(
                    1.0 / 1000000,
                    2.0 / 1000000,
                    provider="cohere",
                    model_family="unknown",
        ...
        if any(pattern in model_lower for pattern in ["gpt-4", "openai"]):
            ...
            return OpenRouterPricing(
                0.5 / 1000000, 1.5 / 1000000, provider="google", model_family="gemini"
            )
        elif any(pattern in model_lower for pattern in ["llama", "meta"]):
            return OpenRouterPricing(
                0.2 / 1000000, 0.2 / 1000000, provider="meta", model_family="llama"
            )
        elif any(pattern in model_lower for pattern in ["mistral", "mixtral"]):
            return OpenRouterPricing(
                1.0 / 1000000, 3.0 / 1000000, provider="mistral", model_family="mistral"
            )
...
def calculate_openrouter_cost(
    ...
    cost, _ = engine.calculate_cost(
        model_name, actual_provider, input_tokens, output_tokens
    )
    return cost
...
def get_cost_breakdown(
    ...
    """
    engine = get_pricing_engine()
    _, breakdown = engine.calculate_cost(
        model_name, actual_provider, input_tokens, output_tokens
    )
    return breakdown
