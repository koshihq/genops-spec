...
try:
    ...
    def instrument_bedrock(*args, **kwargs):
        raise ImportError(
            "Bedrock provider not available. Install with: pip install boto3"
        )
    ...
    def GenOpsBedrockAdapter(*args, **kwargs):  # type: ignore[no-redef]
        raise ImportError(
            "Bedrock provider not available. Install with: pip install boto3"
        )
...
try:
    ...
    def GenOpsHeliconeAdapter(*args, **kwargs):  # type: ignore[no-redef]
        raise ImportError(
            "Helicone provider not available. Install with: pip install 'genops[helicone]'"
        )
...
try:
    ...
    def GenOpsLangfuseAdapter(*args, **kwargs):  # type: ignore[no-redef]
        raise ImportError(
            "Langfuse provider not available. Install with: pip install 'genops[langfuse]'"
        )
...
try:
    ...
    def instrument_arize(*args, **kwargs):
        raise ImportError(
            "Arize provider not available. Install with: pip install 'genops[arize]'"
        )
    ...
    def GenOpsArizeAdapter(*args, **kwargs):  # type: ignore[no-redef]
        raise ImportError(
            "Arize provider not available. Install with: pip install 'genops[arize]'"
        )
...
try:
    ...
    def GenOpsDustAdapter(*args, **kwargs):  # type: ignore[no-redef]
        raise ImportError(
            "Dust provider not available. Install with: pip install requests"
        )
