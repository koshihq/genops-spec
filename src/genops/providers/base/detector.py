...
class FrameworkDetector:
    ...
    def __init__(self):
        self._detected_frameworks: dict[str, FrameworkInfo] | None = None
    ...
    def get_available_frameworks(self, framework_type: str | None = None) -> list[FrameworkInfo]:
        """
    ...
    def get_framework_version(self, name: str) -> str | None:
        """
...
_detector_instance: FrameworkDetector | None = None
