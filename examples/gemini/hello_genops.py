...
def main():
    ...
    try:
        ...
        if "api" in error_str.lower() or "key" in error_str.lower():
            ...
            print(
                '   - Run validation script: python -c "from genops.providers.gemini import validate_setup, print_validation_result; print_validation_result(validate_setup(), detailed=True)"'
            )
