...
def demonstrate_multi_tenant_governance():
    ...
    if successful_tenants:
        ...
        print(f"   Models used: {len(set(t['model'] for t in successful_tenants.values()))}")
...
def demonstrate_cost_governance_enforcement():
    ...
    print(f"   Budget protection: {'✅ Effective' if successful_ops < len(operations) else '❌ Not triggered'}")
