...
from genops.providers.griptape.registration import is_instrumented, get_instrumentation_adapter
...
def main():
    ...
    try:
        ...
        print("🔍 Instrumentation status:", "✅ Enabled" if is_instrumented() else "❌ Disabled")
        
        print("📝 Executing existing Griptape code (no governance)...")
        result1 = run_existing_griptape_code()
        ...
        result2 = run_existing_griptape_code()
        ...
        result3 = run_existing_pipeline_code()
        ...
        if current_adapter:
            ...
            print(f"📦 Current adapter project: {current_adapter.governance_attrs.project}")
        ...
        final_spending = adapter.get_daily_spending() if is_instrumented() else new_daily_spending
