    ...
    sam_template = {
        ...
        "Resources": {
                    ...
                    "Events": {
                        "S3TriggerEvent": {
                            ...
                            "Properties": {
                                ...
                                "Filter": {
                                    "S3Key": {
                                        "Rules": [{"Name": "prefix", "Value": "documents/"}]
                                    }
                                }
                            }
                        }
            ...
            "DocumentsBucket": {
                "Type": "AWS::S3::Bucket",
                "Properties": {
                    "BucketName": {"Fn::Sub": "genops-bedrock-documents-${AWS::AccountId}"},
                    "NotificationConfiguration": {
                        "LambdaConfigurations": [{
                            "Event": "s3:ObjectCreated:*",
                            "Function": {"Fn::GetAtt": ["BatchProcessingFunction", "Arn"]}
                        }]
                    }
                }
            }
        ...
        "Outputs": {
            "DocumentAnalysisApi": {
                ...
                "Value": {"Fn::Sub": "https://${ServerlessRestApi}.execute-api.${AWS::Region}.amazonaws.com/Prod/analyze/"}
            },
            "DocumentsBucketName": {
