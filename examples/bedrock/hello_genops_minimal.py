...
def main():
    ...
    try:
        ...
        print(f"❌ Error: {e}")
        print(
            '💡 Try running the validation: python -c "from genops.providers.bedrock import validate_setup, print_validation_result; print_validation_result(validate_setup())"'
        )
        return False
