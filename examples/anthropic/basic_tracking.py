...
def basic_message_creation():
    ...
    try:
        ...
        client = instrument_anthropic(api_key=os.getenv("ANTHROPIC_API_KEY"))
        ...
        response = client.messages_create(
            ...
            messages=[
                {
                    "role": "user",
                    "content": "Explain artificial intelligence in one clear paragraph.",
                }
            ],
            max_tokens=150,
            temperature=0.7,
        ...
        print("🏷️  Governance: Attributed to team 'ai-examples', project 'genops-demo'")
...
def batch_processing_example():
    ...
    try:
        ...
        with track(
            ...
            print("🏷️  Costs automatically attributed to 'batch-team' project")
    ...
    try:
        ...
        legal_response = client.messages_create(
            ...
            messages=[
                {
                    "role": "user",
                    "content": "What are the key elements of a software license agreement?",
                }
            ],
            max_tokens=200,
        ...
        content_response = client.messages_create(
            ...
            messages=[
                {
                    "role": "user",
                    "content": "Write a compelling headline for a blog post about sustainable technology.",
                }
            ],
            max_tokens=50,
        ...
        service_response = client.messages_create(
            ...
            messages=[
                {
                    "role": "user",
                    "content": "How do I reset my password and ensure my account is secure?",
                }
            ],
            max_tokens=150,
        ...
        print("📊 This enables detailed cost allocation and usage analytics")
    ...
    try:
        ...
        for model_config in models_to_test:
            try:
                ...
                print(
                    f"{model_config['name']:<30} {total_tokens:<10} {response_preview}"
                )
...
def main():
    ...
    if success:
        ...
        print("\n📚 What happened:")
        print(
            "   • Anthropic Claude requests were automatically instrumented with GenOps telemetry"
        )
        ...
        print(
            "   • Explore 'python advanced_features.py' for streaming, conversations, etc."
        )
