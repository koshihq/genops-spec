...
def main():
    ...
    try:
        ...
        if conversation_response.status_code == 200:
            ...
            print(f"⚠️  Conversation creation failed: {conversation_response.status_code}")
        ...
        try:
            ...
            if agent_response.status_code == 200:
                ...
                print(f"⚠️  Agent execution failed (expected): {agent_response.status_code}")
...
def demonstrate_environment_configuration():
    ...
    print(f"  DUST_WORKSPACE_ID: {'✅ Set' if os.getenv('DUST_WORKSPACE_ID') else '❌ Missing'}")
    ...
    print("   • Use OTEL_EXPORTER_OTLP_ENDPOINT to send data to your observability platform")
