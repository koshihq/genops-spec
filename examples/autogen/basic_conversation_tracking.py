...
def main():
    ...
    try:
        ...
        print(f"✅ AutoGen auto-instrumentation enabled")
        print(f"   Team: demo-team")
        print(f"   Project: basic-conversation")
    ...
    print("\n🧹 Step 7: Cleanup...")
    try:
        from genops.providers.autogen import disable_auto_instrumentation, get_instrumentation_stats
        ...
        print(f"   Conversations tracked: {stats['stats'].get('conversations_tracked', 0)}")
