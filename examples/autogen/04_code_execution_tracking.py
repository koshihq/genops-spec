...
def main():
    ...
    try:
        ...
        print(f"✅ Secure governance configured:")
        print(f"   Team: data-science-team")
        print(f"   Project: code-execution-analysis")
        print(f"   Policy: enforced (strict security)")
...
"""
                ...
                context.add_turn(Decimal('0.008'), 450, "code_generator")  # Higher cost for code gen
                ...
                print("   Code Generator: The code executed successfully! Here's the analysis...")
                context.add_turn(Decimal('0.004'), 280, "code_generator")
                
                time.sleep(3)  # Simulate execution time
                
            print(f"   ✅ Code Execution Session 1 completed:")
...
"""
                ...
                print("   Code Generator: I'll implement binary search with comprehensive testing...")
                context.add_turn(Decimal('0.012'), 650, "code_generator")  # Complex algorithm = higher cost
                ...
                context.add_code_execution("python", True)   # Binary search implementation
                ...
                print("   Code Generator: Excellent! All tests passed. Here's the performance analysis...")
                context.add_turn(Decimal('0.006'), 380, "code_generator")
                
                time.sleep(3)
                
            print(f"   ✅ Code Execution Session 2 completed:")
            print(f"      Total cost: ${context.total_cost:.6f}")
            print(f"      Turns: {context.turns_count}")
            print(f"      Code executions: {context.code_executions}")
            print(f"      Function calls: {context.function_calls}")
    ...
    try:
        ...
        print(f"      Languages used: Python")
        print(f"      Avg execution time: 2.5s (simulated)")
        
        # Security and governance insights
        print("\n   Security & Governance:")
        print(f"      Execution environment: {'Sandboxed' if use_real_llm else 'Simulated'}")
        print(f"      Policy violations: 0")
        print(f"      Resource usage: Within limits")
        print(f"      Code safety score: High")
    ...
    try:
        ...
        if 'error' not in analysis:
            ...
            print(f"      Code generation: ~70% (complex reasoning)")
            print(f"      Code execution: ~20% (runtime monitoring)")
            print(f"      Result analysis: ~10% (output processing)")
