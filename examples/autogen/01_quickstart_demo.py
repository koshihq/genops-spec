...
def demo_3_step_quickstart():
    ...
    try:
        ...
        print("✅ Environment validated!" if result else "⚠️  Issues found - check setup")
    ...
    try:
        ...
        if config_list:
            ...
            print("   [Simulated] Assistant: AutoGen is a Microsoft framework for multi-agent")
            print("   [Simulated] conversations where AI agents collaborate to solve tasks.")
    ...
    try:
        ...
        if adapter:
            ...
            print(f"✅ Session tracked successfully:")
