...
def demonstrate_auto_instrumentation():
    ...
    try:
        ...
        print(f"auto_instrument(team='{team}', project='{project}')")
        print("")
    ...
    try:
        ...
        for i, op in enumerate(operations, 1):
            ...
            with adapter.track_routing_session(f"auto-instrumented-{i}") as session:
                ...
                print("   📊 Governance: ✅ Automatically applied")
        ...
        print("   🎯 All operations automatically governed!")
        print()
