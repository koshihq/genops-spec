...
def demonstrate_auto_instrumentation():
    ...
    try:
        ...
        print(
            "🚀 Auto-instrumentation enabled! All PromptLayer operations now include:"
        )
    ...
    try:
        ...
        demo_operations = [
            ...
            },
            {
                ...
                "input": {
                    ...
                    "features": ["Voice control", "Smart scheduling"],
                },
        ...
        for i, operation in enumerate(demo_operations):
            ...
            print("      🏷️ Team attribution: auto-instrumentation-demo")
            print("      📊 Customer attribution: demo-customer")
            print()
        ...
        print(
            "   • Works with all PromptLayer features (versioning, A/B testing, etc.)"
        )
        print()
...
def demonstrate_configuration_options():
    ...
    try:
        from genops.providers.promptlayer import auto_instrument  # noqa: F401
