...
def main():
    ...
    if api_key:
        ...
        print(
            "   Get your project API key at: https://app.posthog.com/project/settings"
        )
    ...
    analytics_contexts = {
        "Jupyter Notebook": any(
            "jupyter" in str(sys.modules.get(mod, "")) for mod in sys.modules
        ),
    ...
    detected_contexts = [
        context for context, detected in analytics_contexts.items() if detected
    ]
