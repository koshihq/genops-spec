...
def main():
    ...
    print()
    print(
        "This wizard will guide you through setting up PostHog with GenOps governance."
    )
    ...
    try:
        ...
        print()
        print(
            "📚 Documentation: https://github.com/KoshiHQ/GenOps-AI/tree/main/examples/posthog"
        )
        return False
