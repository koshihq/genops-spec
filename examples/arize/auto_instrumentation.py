...
def demonstrate_before_instrumentation():
    ...
    try:
        ...
        print(
            f"     • Model: {sample_prediction['model_id']}-{sample_prediction['model_version']}"
        )
...
def demonstrate_after_instrumentation(adapter):
    ...
    try:
        ...
        if adapter:
            ...
            print(
                f"     • Cost Alerts: {'Enabled' if metrics['cost_alerts_enabled'] else 'Disabled'}"
            )
...
def demonstrate_monitoring_and_observability():
    ...
    try:
        ...
        if adapter:
            ...
            print(
                f"     • Active Sessions: {metrics.get('active_monitoring_sessions', 0)}"
            )
