    ...
    troubleshooting_scenarios = [
        {
            ...
            'diagnosis': ['Check prediction volume', 'Review alert frequency', 'Analyze data quality checks'],
            'solutions': ['Implement sampling', 'Optimize alert thresholds', 'Reduce check frequency']
        },
        {
            'issue': 'Authentication failures',
            'diagnosis': ['Verify API keys', 'Check network connectivity', 'Validate permissions'],
            'solutions': ['Rotate API keys', 'Update firewall rules', 'Contact Arize support']
        },
        {
            'issue': 'Budget alerts firing',
            'diagnosis': ['Check daily usage', 'Review model activity', 'Analyze cost trends'],
