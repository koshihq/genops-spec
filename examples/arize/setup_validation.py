...
def check_environment_setup() -> dict[str, Any]:
    ...
    env_status = {"required_missing": [], "recommended_missing": [], "configured": {}}
...
def run_quick_validation_checks():
    ...
    try:
        ...
        print(
            f"  ✅ Arize AI SDK installed (version: {getattr(arize, '__version__', 'unknown')})"
        )
        checks_passed += 1
    except ImportError:
    ...
    try:
        from genops.providers.arize import GenOpsArizeAdapter  # noqa: F401
