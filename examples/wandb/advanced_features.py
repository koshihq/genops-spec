...
def run_multi_run_campaign(adapter, campaign_config: CampaignGovernanceConfig) -> AdvancedMLCampaign:
    ...
    for exp_config in experiment_configs:
        ...
        if campaign.total_cost > campaign_config.max_total_cost * 0.9:
            print("   ⚠️  Campaign approaching budget limit, skipping remaining experiments")
            break
...
def main():
    ...
    try:
        ...
        print("   📊 Insights: Performance vs cost optimization across distributed workloads")
        print("   🔐 Security: Role-based access control and comprehensive audit trails")
