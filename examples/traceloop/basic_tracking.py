...
def basic_openllmetry_with_genops():
    ...
    try:
        ...
        if "api key" in str(e).lower():
            ...
            print(
                "   💡 Network Issue: Check internet connection and firewall settings"
            )
        return False
    ...
    try:
        ...
        if "rate limit" in str(e).lower():
            print(
                "   💡 Rate Limit: Implement exponential backoff or reduce batch size"
            )
...
def show_openllmetry_integration():
    ...
    try:
        ...
        print(
            f"   • OpenLLMetry version: {getattr(openllmetry, '__version__', 'unknown')}"
        )
