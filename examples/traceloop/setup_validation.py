...
def main():
    ...
    try:
        ...
        print(
            "   💡 Fix: Run 'pip install openllmetry' or 'pip install genops[traceloop]'"
        )
        return False
    ...
    if traceloop_api_key:
        ...
        print(
            "   💡 For commercial features, get your key at: https://app.traceloop.com"
        )
    ...
    try:
        ...
        if validation_result and hasattr(validation_result, "overall_status"):
            if validation_result.overall_status.value == "PASSED":
                print(
                    "🎉 Success! Your Traceloop + OpenLLMetry + GenOps setup is ready!"
                )
                print("\n🔍 Enhanced Observability Stack Active:")
                print(
                    "   • OpenLLMetry tracing ✅ Open-source LLM observability foundation"
                )
                print(
                    "   • GenOps governance ✅ Enhanced with cost intelligence and policy enforcement"
                )

                if traceloop_api_key:
                    print(
                        "   • Traceloop platform ✅ Commercial insights and enterprise features"
                    )
                else:
                    print(
                        "   • Traceloop platform ⚠️  Available with API key (optional)"
                    )
                ...
                print("\n📚 Next steps:")
                print(
                    "   • Run 'python basic_tracking.py' for OpenLLMetry + GenOps foundation"
                )
                print(
                    "   • Run 'python auto_instrumentation.py' for zero-code integration"
                )
                print(
                    "   • Run 'python traceloop_platform.py' for commercial platform features"
                )

                print("\n💡 Quick Test:")
                print("   Try this command to test your enhanced observability:")
                print(
                    "   python -c \"from genops.providers.traceloop import instrument_traceloop; print('Enhanced observability ready!')\""
                )
...
def demonstrate_quick_integration():
    ...
    try:
        ...
        instrument_traceloop(
            team="validation-demo", project="setup-check", environment="development"
        )
