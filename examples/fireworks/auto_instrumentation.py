...
try:
    ...
    from genops.providers.fireworks import FireworksModel, auto_instrument  # noqa: F401
    ...
    try:
        ...
        response = client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "user",
                    "content": "What are the benefits of auto-instrumentation?",
                }
            ],
            max_tokens=100,
        )
    ...
    try:
        ...
        response = client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "user",
                    "content": "What are the benefits of auto-instrumentation with fast inference?",
                }
            ],
            max_tokens=100,
        )
...
def demonstrate_mixed_models():
    ...
    for model, tier, pricing in models_to_test:
        try:
            ...
            print("   🎯 Automatic governance tracking active!")
...
def demonstrate_embedding_auto_instrumentation():
    ...
    try:
        ...
        response = client.embeddings.create(
            ...
            input=[
                "Fast AI inference is crucial for production",
                "Fireworks AI delivers 4x speed improvements",
            ],
        )
        ...
        functions = [
            {
                ...
                "parameters": {
                    ...
                    "properties": {
                        "metric": {
                            "type": "string",
                            "description": "Speed metric to query",
                        }
                    },
                },
            }
