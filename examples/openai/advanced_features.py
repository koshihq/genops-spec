...
def vision_api_example():
    ...
    try:
        ...
        print("   • Image detail level affects token count and cost")
        print("   • Higher detail = more tokens = higher cost")
        print("   • Image dimensions and complexity impact processing")
...
def batch_operations_optimization():
    ...
    try:
        ...
        with track("batch_optimization",
            ...
            print("   • Used cost-effective GPT-3.5-Turbo for batch processing")
            print("   • Limited max_tokens to control costs")
            print("   • Consistent temperature for predictable results")
            print("   • Batch attribution for unified cost tracking")
