...
def main():
    ...
    print(f"Model: meta-llama/Llama-2-70b-chat-hf")
    ...
    print(f"Feature: chat-completion")
    ...
    print(f"Model: meta-llama/Llama-2-7b-chat-hf (smaller, cheaper)")
    ...
    print("   ✅ Governance attributes (team, customer, feature) enable cost attribution")
