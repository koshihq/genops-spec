...
class InteractiveSetupWizard:
    ...
    def _generate_env_file(self):
        ...
        # Security: Create sanitized content for file writing
        safe_content = self._create_safe_env_content()
    ...
    def _create_safe_env_content(self):
        """Create sanitized environment content safe for file writing."""
        # Security: Always use placeholder for API key, never real sensitive data
        safe_api_key = 'pplx-your-api-key-here'
        
        safe_content = f"""# Perplexity AI + GenOps Configuration
# Generated by setup wizard on {datetime.now().isoformat()}
# SECURITY: Replace 'pplx-your-api-key-here' with your actual API key

# Required Settings
PERPLEXITY_API_KEY={safe_api_key}
